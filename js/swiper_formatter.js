  ...
  Drupal.behaviors.swiperFormatter = {
    attach: function (context, settings) {
      ...
      if (swiper_formatter_settings && $.type(swiper_formatter_settings.swipers) !== 'undefined') {
        ...
        once('swiperFormaterInit', '.swiper-container', context).forEach(
              ...
              if (typeof swiperSettings === 'object' && typeof Swiper !== 'undefined') {
                ...
                if (swipers[swiperContainer.id]) {
                  ...
                  self.registerTriggers(
                    swipers[swiperContainer.id],
                    $(context).find('.swiper-trigger'),
                    context,
                    settings
                  );

                  // Send swipers to the front-end.
